...
public class Connector {
  ...
  private List<TenantAndCredential> tenants = null;
  ...
  **/
  ...
  public Connector tenants(List<TenantAndCredential> tenants) {
  ...
  public Connector addTenantsItem(TenantAndCredential tenantsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of analytic tenants and credentials to be assigned to the connector.")

  public List<TenantAndCredential> getTenants() {
    return tenants;
  }


  public void setTenants(List<TenantAndCredential> tenants) {
   ...
   * @return the Connector instance itself
   */
  public Connector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectorId, connector.connectorId) &&
        Objects.equals(this.tenants, connector.tenants)&&
        Objects.equals(this.additionalProperties, connector.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectorId, tenants, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Connector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("tenants") != null && !jsonObj.get("tenants").isJsonNull()) {
        ...
        if (jsonArraytenants != null) {
          ...
          for (int i = 0; i < jsonArraytenants.size(); i++) {
            TenantAndCredential.validateJsonObject(jsonArraytenants.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Connector>() {
           ...
           public Connector read(JsonReader in) throws IOException {
             ...
             Connector instance = thisAdapter.fromJsonTree(jsonObj);
