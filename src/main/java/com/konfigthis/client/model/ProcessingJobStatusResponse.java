...
public class ProcessingJobStatusResponse {
  ...
  public ProcessingJobStatusResponse() {
  }

  public ProcessingJobStatusResponse parentJobId(String parentJobId) {
  ...
  **/
  ...
  public ProcessingJobStatusResponse parentTenantCode(String parentTenantCode) {
  ...
  **/
  ...
  public ProcessingJobStatusResponse limit(Integer limit) {
  ...
  **/
  ...
  public ProcessingJobStatusResponse start(Integer start) {
  ...
  **/
  ...
  public ProcessingJobStatusResponse processingJobs(List<ProcessingJob> processingJobs) {
  ...
  public ProcessingJobStatusResponse addProcessingJobsItem(ProcessingJob processingJobsItem) {
  ...
  **/
   ...
   * @return the ProcessingJobStatusResponse instance itself
   */
  public ProcessingJobStatusResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProcessingJobStatusResponse processingJobStatusResponse = (ProcessingJobStatusResponse) o;
    return Objects.equals(this.parentJobId, processingJobStatusResponse.parentJobId) &&
        Objects.equals(this.parentTenantCode, processingJobStatusResponse.parentTenantCode) &&
        Objects.equals(this.limit, processingJobStatusResponse.limit) &&
        Objects.equals(this.start, processingJobStatusResponse.start) &&
        Objects.equals(this.processingJobs, processingJobStatusResponse.processingJobs)&&
        Objects.equals(this.additionalProperties, processingJobStatusResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingJobStatusResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProcessingJobStatusResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProcessingJobStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProcessingJobStatusResponse is not found in the empty JSON string", ProcessingJobStatusResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProcessingJobStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProcessingJobStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProcessingJobStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProcessingJobStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ProcessingJobStatusResponse>() {
           @Override
           public void write(JsonWriter out, ProcessingJobStatusResponse value) throws IOException {
           ...
           @Override
           public ProcessingJobStatusResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProcessingJobStatusResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProcessingJobStatusResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProcessingJobStatusResponse
  * @throws IOException if the JSON string is invalid with respect to ProcessingJobStatusResponse
  */
  public static ProcessingJobStatusResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProcessingJobStatusResponse.class);
  }

 /**
  * Convert an instance of ProcessingJobStatusResponse to an JSON string
  *
  * @return JSON string
  */
