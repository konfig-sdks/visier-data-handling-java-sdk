...
public class ReceivingJobStatusResponse {
  ...
  **/
  ...
  public ReceivingJobStatusResponse receivingJobs(List<ReceivingJob> receivingJobs) {
  ...
  public ReceivingJobStatusResponse addReceivingJobsItem(ReceivingJob receivingJobsItem) {
