...
public class Result {
  ...
  public Result jobId(String jobId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "If applicable, the job ID associated with the data version.")
  ...
  public Result dataVersion(String dataVersion) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If applicable, the data version that was disabled.")
  ...
  public Result tenantCode(String tenantCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The analytic tenant that the disable operation was conducted for.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The outcome of the disabling operation.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If applicable, the message explains what errors occurred while disabling data versions.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jobId, result.jobId) &&
        Objects.equals(this.dataVersion, result.dataVersion) &&
        Objects.equals(this.tenantCode, result.tenantCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(jobId, dataVersion, tenantCode, status, message, additionalProperties);
  }
